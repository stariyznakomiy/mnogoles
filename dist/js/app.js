 ...
 */
    ...
    (() => {
        ...
        flsModules.tippy = tippy_esm("[data-tippy-content]", {
            content(reference) {
                const template = reference.querySelector("[data-tippy-body]");
        ...
        function initSliders() {
            if (document.querySelector('[data-js-slide="production-thumbs"]')) var productionThumbs = new swiper_core_Swiper('[data-js-slide="production-thumbs"]', {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector('[data-js-slide="production"]')) {
                const prev = document.querySelector('[data-js-slide="production-prev"]'), next = document.querySelector('[data-js-slide="production-next"]');
                new swiper_core_Swiper('[data-js-slide="production"]', {
            ...
            if (document.querySelector('[data-js-slide="reviews"]')) {
                const reviewsThumbs = new swiper_core_Swiper('[data-js-slide="reviews-thumbs"]', {
                ...
                const prev = document.querySelector('[data-js-slide="reviews-prev"]'), next = document.querySelector('[data-js-slide="reviews-next"]');
                var reviewsSlider = new swiper_core_Swiper('[data-js-slide="reviews"]', {
                ...
                function updateActiveSlide(activeIndex, slides) {
                    if (activeIndex !== void 0) slides.forEach(((slide, index) => {
        ...
        if (map) {
            ...
            function init() {
                ...
                const BalloonLayout = ymaps.templateLayoutFactory.createClass('<div class="map__balloon">$[properties.balloonContent]</div>');
                ...
                map.controls.remove("geolocationControl").remove("searchControl").remove("trafficControl").remove("typeSelector").remove("fullscreenControl").remove("rulerControl");
            }
        }
        window["FLS"] = true;
        isWebp();
